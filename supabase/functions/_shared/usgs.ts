 ...
 */
import type { ParkLike, UsgsParameter, UsgsPayload, UsgsReading } from "./types.ts";
...
type ParkGaugeFields = Pick<ParkLike, "usgs_site_id" | "river_gauge_site_id"> & Partial<Pick<ParkLike, "name" | "gauge_distance_km">>;
