  ...
  return (
    <Section id="prediction" title="Will it fill up?" icon={<CalendarClock />} action={<Badge variant="estimate" />}>
      <Card className="space-y-3">
        ...
        <p className="text-sm text-mocha">{CONFIDENCE_HELP[prediction.confidence]}</p>
        ...
        <details className="group rounded-xl bg-cream p-3">
          ...
          <p className="mt-2 text-xs text-mocha">
            ...
            <Link href="/about#prediction" className="font-bold text-brown underline underline-offset-2">
